...
$api = json_decode(file_get_contents("ciszek.y0.pl/eagle space/api/mission/dan.txt"));
//$video = '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$api->[$nw]->video.'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
?>
<!DOCTYPE html>
<html>
<head>
...
const api = '/eagle%20space/api/mission/dan.txt';
const apii = await fetch(api);
const appi = await apii.json();
var idd = 0;

document.getElementById("LM").innerHTML = appi.Mission.rocket+" | "+appi.Mission[idd].name;
document.getElementById("opisss").innerHTML = appi.Mission[idd].description;


var countDownDate = new Date(appi.Mission[idd].date).getTime();
...
var countDownDate = new Date(appi.Mission[idd].Staticdate).getTime();
